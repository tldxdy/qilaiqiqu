...
public class SideslipDeleteListView extends ListView {
		...
		public SideslipDeleteListView(Context context, AttributeSet attrs) {
			this(context, attrs, 0);
		}

		public SideslipDeleteListView(Context context, AttributeSet attrs, int defStyle) {
