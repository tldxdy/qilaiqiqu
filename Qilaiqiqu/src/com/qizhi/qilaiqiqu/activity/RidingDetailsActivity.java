...
public class RidingDetailsActivity extends Activity implements OnClickListener, CallBackPost{
	...
	public void onClick(View v) {
		...
		case R.id.img_ridingDetailsActivity_cllection:
			if (cllectionFlag == 1) {
				...
				params2.addBodyParameter("uniqueKey", preferences.getString("uniqueKey", null));
				xUtilsUtil.httpPost("mobile/articleMemo/appendArticleMemoCollect.html", params2, this);
				
			} else {
				RequestParams params3 = new RequestParams();
				params3.addBodyParameter("userId", preferences.getInt("userId", -1) + "");
				params3.addBodyParameter("articleId", articleId + "");
				params3.addBodyParameter("uniqueKey", preferences.getString("uniqueKey", null));
				xUtilsUtil.httpPost("mobile/articleMemo/deleteArticleMemoCollect.html", params3, this);
			}
			break;
	...
	private void likeChosen() {
		...
		params2.addBodyParameter("articleId", articleId + "");
		params2.addBodyParameter("uniqueKey", preferences.getString("uniqueKey", null));
		xUtilsUtil.httpPost("mobile/articleMemo/praiseArticle.html", params2, new CallBackPost() {
			...
			public void onMySuccess(ResponseInfo<String> responseInfo) {
				...
				if(jsonObject.optBoolean("result")){
					...
					articleModel.setPraiseNum(articleModel.getPraiseNum()+1);
	...
	private void likeUnChosen() {
		...
		params3.addBodyParameter("articleId", articleId + "");
		params3.addBodyParameter("uniqueKey", preferences.getString("uniqueKey", null));
		xUtilsUtil.httpPost("mobile/articleMemo/unPraiseArticle.html", params3, new CallBackPost() {
	...
	public void rewardIntegral(final int markPointInt) {
		if(preferences.getInt("userId", -1) != -1){
			...
			xUtilsUtil.httpPost("mobile/articleMemo/articleMemoReward.html", params, new CallBackPost() {
				...
				public void onMySuccess(ResponseInfo<String> responseInfo) {
					...
					if(jsonObject.optBoolean("result")){
						new SystemUtil().makeToast(RidingDetailsActivity.this, "您打赏了"
								+ markPointInt + "分!");
					}else{
						new SystemUtil().makeToast(RidingDetailsActivity.this, jsonObject.optString("message") );
					}
				}
	...
	private void uoloadData() {
		...
		xUtilsUtil.httpPost("common/articleMemoDetail.html", params, new CallBackPost() {
			...
			public void onMySuccess(ResponseInfo<String> responseInfo) {
				...
				if(jsonObject.optBoolean("result")){
					Gson gson =new Gson();
					Type type = new TypeToken<ArticleMemoDetailModel>(){}.getType();
					aDetailModel = gson.fromJson(jsonObject.optString("data"), type);
					...
					System.out.println(aDetailModel.isUserCollected()+":"+aDetailModel.isUserPraised());
