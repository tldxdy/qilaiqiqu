...
public class PersonActivity extends Activity implements OnClickListener, CallBackPost{
	...
	public void onClick(View v) {
		...
		case R.id.txt_personActivity_care:
			...
			if (careFlagInt == 1) {
				...
				xUtilsUtil.httpPost("mobile/attention/appendAttention.html", params2, this);
			} else {
				...
				xUtilsUtil.httpPost("mobile/attention/cancelAttention.html", params3, this);
			}
	...
	protected void onStart() {
		...
		if(preferences.getInt("userId", -1) != -1){
			params.addBodyParameter("loginUserId", preferences.getInt("userId", -1) + "");
		}
		xUtilsUtil.httpPost("common/queryCertainUser.html", params, new CallBackPost() {
			...
			public void onMySuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					...
					if(jsonObject.optBoolean("result")){
						...
						Gson gson = new Gson();
						certainUserModel = gson.fromJson(jo.toString(), CertainUserModel.class);
						careNumTxt.setText(certainUserModel.getConcernNum()+"");
						fansNum = jo.optInt("fansNum");
						fansNumTxt.setText(certainUserModel.getFansNum()+"");
						...
						if("null".equals(certainUserModel.getUserMemo()) || "".equals(certainUserModel.getUserMemo())){
							...
							introduceTxt.setText(certainUserModel.getUserMemo());
						}
						if("".equals(certainUserModel.getAddress()) || "null".equals(certainUserModel.getAddress()) || certainUserModel.getAddress() ==null){
							cityTxt.setText("");
							provinceTxt.setText("");
							districtTet.setText("");
						}else{
						...
						SystemUtil.loadImagexutils(certainUserModel.getUserImage(), photoImg, PersonActivity.this);
