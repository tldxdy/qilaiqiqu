...
public class PersonalDataActivity extends BaseActivity implements
	 ...
	 * 
	 * // 一个自定义的布局，作为显示的内容 View mview = LayoutInflater.from(this).inflate(
	 * R.layout.popup_personaldataactivity, null);
	 * 
	 * cancelBtn = (Button) mview
	 * .findViewById(R.id.btn_personaldataactivity_cancel); photographBtn =
	 * (Button) mview .findViewById(R.id.btn_personaldataactivity_photograph);
	 * phoneBtn = (Button) mview
	 * .findViewById(R.id.btn_personaldataactivity_phone); LinearLayout quxiao =
	 * (LinearLayout) mview.findViewById(R.id.quxiao);
	 * 
	 ...
	 * 
	 * @Override public void onClick(View v) { popupWindow.dismiss(); Intent i =
	 * new Intent( Intent.ACTION_PICK,
	 * android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);//
	 * 调用android的图库 i.setType("image/*"); startActivityForResult(i,
	 * IMAGE_REQUEST_CODE); } }); photographBtn.setOnClickListener(new
	 * OnClickListener() {
	 * 
	 * @Override public void onClick(View v) { popupWindow.dismiss();
	 * //openCamera(); Intent intent = new
