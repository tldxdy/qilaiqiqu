...
public class FansModel {
	...
	private ArrayList<FansDataList> dataList;

	public class FansDataList implements Serializable{
		/**
		 * 
		 */
	...
	public ArrayList<FansDataList> getDataList() {
		return dataList;
	}

	public void setDataList(ArrayList<FansDataList> dataList) {
